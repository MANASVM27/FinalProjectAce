...
const About = () =>{
  ...
  <p className='h22'><font face="calibri"><b>Best Selling Holidays</b></font></p>     
  <p className='h33'><font face="calibri"><i>CHECK OUT OUR MOST POPULAR HOLIDAYS RIGHT HERE!</i>
</font></p> 
...
<div class="foods">
                    <div class="all1">
                        ...
                        <div class="all2">
                            <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1670308721/wp9160943-nature-dark-4k-wallpapers_anokmu.jpg" height={200} width={280}/>
                    ...
                    <div class="all3">
                        <div class="all4">
                            <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1670312105/wall2_zhaeja.jpg" height={200} width={280}/>
                            <Link to ="/payment"><h4>VIETNAM</h4></Link>
                        </div>
                    </div> 
                    <div class="all5">
                        <div class="all6">
                            <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1670312105/wall3_qepbxz.jpg" height={200} width={280}/>
                    ...
                    <div class="all7">
                        <div class="all8">
                            <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1670341512/effel_mqh7jw.jpg" height={200} width={280}/>
                            <h4>EIFFEL TOWER</h4>
                        </div>
                    </div> 
                    <div class="all9">
                        <div class="all10">
                            <img src="https://res.cloudinary.com/dtcdcvkki/image/upload/v1670341549/taaj_xulxw5.jpg" height={200} width={280}/>
                            <h4>TAJ MAHAL</h4>
                        </div>
                    </div>
                    </div> 
...
<div className='quote'><p>Calming sounds of the ocean, charming beach shacks and endless nights!</p>
</div>
</div>   
</Section>
    )
